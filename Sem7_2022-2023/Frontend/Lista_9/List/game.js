...
;
var elixirDiffs = ["Unknown", "Advanced", "Moderate", "Beginner", "OrdinaryWizardingLevel",
    "OneOfAKind"];
var spellLights = ["None", "Blue", "IcyBlue", "Red", "Gold",
    ...
    "BrightYellow", "BlackSmoke"];
var spellTypes = ["None", "Charm", "Conjuration", "Spell", "Transfiguration",
...
function isElixir(obj) {
    return obj.effect.length > 0;
}
function isSpell(obj) {
    return obj.incantation.length > 0;
}
